...
const DeiPageTemplate = () => {
  return (
    <div>
      <section className='custom-medium-section is-large has-background-black'>
      ...
      <section className='custom-medium-section'>
        ...
        <p className='pr-5 pt-5 is-size-4-desktop'>
          ...
          commitment to embrace diverse identities, thoughts, and backgrounds,
          free from implicit bias. We believe that diversity of people leads to
          the diversity of thought, creativity, and a more equitable workplace
          and world. We are committed to being allies and advocates for
          marginalized people everywhere. We stand alongside anyone !ghting for
          Social Justice, Racial Justice, and Economic Justice.{' '}
        </p>
      </section>
