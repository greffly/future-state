/* eslint-disable semi */
module.exports = {
  siteTitle: 'Future State Consulting', // Site title.
  siteTitleAlt: 'Future State Consulting', // Alternative site title for SEO.
  ...
  userName: 'Caitlyn Greffly',
  userTwitter: 'thecaitcode',
  userLocation: 'Portland, OR',
  userDescription: '',
  copyright: 'Copyright © Future State Consulting 2021.', // Copyright string for the footer of the website and RSS feed.
